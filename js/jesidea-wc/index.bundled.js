 ...
 */
const t="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,i=(t,i,e=null)=>{for(;i!==e;){const e=i.nextSibling;t.removeChild(i),i=e}},e=`{{lit-${String(Math.random()).slice(2)}}}`,s=`\x3c!--${e}--\x3e`,n=new RegExp(`${e}|${s}`);class o{constructor(t,i){this.parts=[],this.element=i;const s=[],o=[],a=document.createTreeWalker(i.content,133,null,!1);let c=0,A=-1,d=0;const{strings:u,values:{length:m}}=t;for(;d<m;){const t=a.nextNode();if(null!==t){if(A++,1===t.nodeType){if(t.hasAttributes()){const i=t.attributes,{length:e}=i;let s=0;for(let t=0;t<e;t++)r(i[t].name,"$lit$")&&s++;for(;s-- >0;){const i=u[d],e=h.exec(i)[2],s=e.toLowerCase()+"$lit$",o=t.getAttribute(s);t.removeAttribute(s);const r=o.split(n);this.parts.push({type:"attribute",index:A,name:e,strings:r}),d+=r.length-1}}"TEMPLATE"===t.tagName&&(o.push(t),a.currentNode=t.content)}else if(3===t.nodeType){const i=t.data;if(i.indexOf(e)>=0){const e=t.parentNode,o=i.split(n),a=o.length-1;for(let i=0;i<a;i++){let s,n=o[i];if(""===n)s=l();else{const t=h.exec(n);null!==t&&r(t[2],"$lit$")&&(n=n.slice(0,t.index)+t[1]+t[2].slice(0,-"$lit$".length)+t[3]),s=document.createTextNode(n)}e.insertBefore(s,t),this.parts.push({type:"node",index:++A})}""===o[a]?(e.insertBefore(l(),t),s.push(t)):t.data=o[a],d+=a}}else if(8===t.nodeType)if(t.data===e){const i=t.parentNode;null!==t.previousSibling&&A!==c||(A++,i.insertBefore(l(),t)),c=A,this.parts.push({type:"node",index:A}),null===t.nextSibling?t.data="":(s.push(t),A--),d++}else{let i=-1;for(;-1!==(i=t.data.indexOf(e,i+1));)this.parts.push({type:"node",index:-1}),d++}}else a.currentNode=o.pop()}for(const t of s)t.parentNode.removeChild(t)}}const r=(t,i)=>{const e=t.length-i.length;return e>=0&&t.slice(e)===i},a=t=>-1!==t.index,l=()=>document.createComment(""),h=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function c(t,i){const{element:{content:e},parts:s}=t,n=document.createTreeWalker(e,133,null,!1);let o=d(s),r=s[o],a=-1,l=0;const h=[];let c=null;for(;n.nextNode();){a++;const t=n.currentNode;for(t.previousSibling===c&&(c=null),i.has(t)&&(h.push(t),null===c&&(c=t)),null!==c&&l++;void 0!==r&&r.index===a;)r.index=null!==c?-1:r.index-l,o=d(s,o),r=s[o]}h.forEach(t=>t.parentNode.removeChild(t))}const A=t=>{let i=11===t.nodeType?0:1;const e=document.createTreeWalker(t,133,null,!1);for(;e.nextNode();)i++;return i},d=(t,i=-1)=>{for(let e=i+1;e<t.length;e++){const i=t[e];if(a(i))return e}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class b{constructor(t,i,e){this.t=[],this.template=t,this.processor=i,this.options=e}update(t){let i=0;for(const e of this.t)void 0!==e&&e.setValue(t[i]),i++;for(const t of this.t)void 0!==t&&t.commit()}_clone(){const i=t?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),e=[],s=this.template.parts,n=document.createTreeWalker(i,133,null,!1);let o,r=0,l=0,h=n.nextNode();for(;r<s.length;)if(o=s[r],a(o)){for(;l<o.index;)l++,"TEMPLATE"===h.nodeName&&(e.push(h),n.currentNode=h.content),null===(h=n.nextNode())&&(n.currentNode=e.pop(),h=n.nextNode());if("node"===o.type){const t=this.processor.handleTextExpression(this.options);t.insertAfterNode(h.previousSibling),this.t.push(t)}else this.t.push(...this.processor.handleAttributeExpressions(h,o.name,o.strings,this.options));r++}else this.t.push(void 0),r++;return t&&(document.adoptNode(i),customElements.upgrade(i)),i}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const w=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:t=>t}),y=` ${e} `;class f{constructor(t,i,e,s){this.strings=t,this.values=i,this.type=e,this.processor=s}getHTML(){const t=this.strings.length-1;let i="",n=!1;for(let o=0;o<t;o++){const t=this.strings[o],r=t.lastIndexOf("\x3c!--");n=(r>-1||n)&&-1===t.indexOf("--\x3e",r+1);const a=h.exec(t);i+=null===a?t+(n?y:s):t.substr(0,a.index)+a[1]+a[2]+"$lit$"+a[3]+e}return i+=this.strings[t],i}getTemplateElement(){const t=document.createElement("template");let i=this.getHTML();return void 0!==w&&(i=w.createHTML(i)),t.innerHTML=i,t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const x=t=>null===t||!("object"==typeof t||"function"==typeof t),v=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class R{constructor(t,i,e){this.dirty=!0,this.element=t,this.name=i,this.strings=e,this.parts=[];for(let t=0;t<e.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new M(this)}_getValue(){const t=this.strings,i=t.length-1,e=this.parts;if(1===i&&""===t[0]&&""===t[1]){const t=e[0].value;if("symbol"==typeof t)return String(t);if("string"==typeof t||!v(t))return t}let s="";for(let n=0;n<i;n++){s+=t[n];const i=e[n];if(void 0!==i){const t=i.value;if(x(t)||!v(t))s+="string"==typeof t?t:String(t);else for(const i of t)s+="string"==typeof i?i:String(i)}}return s+=t[i],s}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class M{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===p||x(t)&&t===this.value||(this.value=t,m(t)||(this.committer.dirty=!0))}commit(){for(;m(this.value);){const t=this.value;this.value=p,t(this)}this.value!==p&&this.committer.commit()}}class k{constructor(t){this.value=void 0,this.i=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(l()),this.endNode=t.appendChild(l())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.s(this.startNode=l()),t.s(this.endNode=l())}insertAfterPart(t){t.s(this.startNode=l()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.i=t}commit(){if(null===this.startNode.parentNode)return;for(;m(this.i);){const t=this.i;this.i=p,t(this)}const t=this.i;t!==p&&(x(t)?t!==this.value&&this.o(t):t instanceof f?this.l(t):t instanceof Node?this.h(t):v(t)?this.A(t):t===g?(this.value=g,this.clear()):this.o(t))}s(t){this.endNode.parentNode.insertBefore(t,this.endNode)}h(t){this.value!==t&&(this.clear(),this.s(t),this.value=t)}o(t){const i=this.startNode.nextSibling,e="string"==typeof(t=null==t?"":t)?t:String(t);i===this.endNode.previousSibling&&3===i.nodeType?i.data=e:this.h(document.createTextNode(e)),this.value=t}l(t){const i=this.options.templateFactory(t);if(this.value instanceof b&&this.value.template===i)this.value.update(t.values);else{const e=new b(i,t.processor,this.options),s=e._clone();e.update(t.values),this.h(s),this.value=e}}A(t){Array.isArray(this.value)||(this.value=[],this.clear());const i=this.value;let e,s=0;for(const n of t)e=i[s],void 0===e&&(e=new k(this.options),i.push(e),0===s?e.appendIntoPart(this):e.insertAfterPart(i[s-1])),e.setValue(n),e.commit(),s++;s<i.length&&(i.length=s,this.clear(e&&e.endNode))}clear(t=this.startNode){i(this.startNode.parentNode,t.nextSibling,this.endNode)}}class B{constructor(t,i,e){if(this.value=void 0,this.i=void 0,2!==e.length||""!==e[0]||""!==e[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=i,this.strings=e}setValue(t){this.i=t}commit(){for(;m(this.i);){const t=this.i;this.i=p,t(this)}if(this.i===p)return;const t=!!this.i;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.i=p}}class S extends R{constructor(t,i,e){super(t,i,e),this.single=2===e.length&&""===e[0]&&""===e[1]}_createPart(){return new I(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class I extends M{}let E=!1;(()=>{try{const t={get capture(){return E=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class J{constructor(t,i,e){this.value=void 0,this.i=void 0,this.element=t,this.eventName=i,this.eventContext=e,this.u=t=>this.handleEvent(t)}setValue(t){this.i=t}commit(){for(;m(this.i);){const t=this.i;this.i=p,t(this)}if(this.i===p)return;const t=this.i,i=this.value,e=null==t||null!=i&&(t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive),s=null!=t&&(null==i||e);e&&this.element.removeEventListener(this.eventName,this.u,this.m),s&&(this.m=Z(t),this.element.addEventListener(this.eventName,this.u,this.m)),this.value=t,this.i=p}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const Z=t=>t&&(E?{capture:t.capture,passive:t.passive,once:t.once}:t.capture)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,i,e,s){const n=i[0];if("."===n){return new S(t,i.slice(1),e).parts}if("@"===n)return[new J(t,i.slice(1),s.eventContext)];if("?"===n)return[new B(t,i.slice(1),e)];return new R(t,i,e).parts}handleTextExpression(t){return new k(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const U=(t,...i)=>new f(t,i,"html",N)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const q=t=>i=>"function"==typeof i?((t,i)=>(window.customElements.define(t,i),i))(t,i):((t,i)=>{const{kind:e,elements:s}=i;return{kind:e,elements:s,finisher(i){window.customElements.define(t,i)}}})(t,i),L=(t,i)=>"method"===i.kind&&i.descriptor&&!("value"in i.descriptor)?Object.assign(Object.assign({},i),{finisher(e){e.createProperty(i.key,t)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},initializer(){"function"==typeof i.initializer&&(this[i.key]=i.initializer.call(this))},finisher(e){e.createProperty(i.key,t)}};function V(t){return(i,e)=>void 0!==e?((t,i,e)=>{i.constructor.createProperty(e,t)})(t,i,e):L(t,i)}
/**
@license
 ...
 * http://polymer.github.io/PATENTS.txt
 */
var et=function(t,i,e,s){for(var n,o=arguments.length,r=o<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,e):s,a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(i,e,r):n(i,e))||r);return o>3&&r&&Object.defineProperty(i,e,r),r};let st=class extends it{constructor(){super(...arguments),this.name="World",this.count=0}render(){return U`
  ...
  `,et([V()],st.prototype,"name",void 0),et([V({type:Number})],st.prototype,"count",void 0),st=et([q("my-element")],st);customElements.define("lit-media-query",class extends it{static get properties(){return{query:{type:String},_match:{type:Boolean}}}constructor(){super(),this.query="(max-width:460px)",this._match=!1}render(){return U`
    <style>
      :host {
        display: none;
      }
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class nt{constructor(t){this.classes=new Set,this.changed=!1,this.element=t;const i=(t.getAttribute("class")||"").split(/\s+/);for(const t of i)this.classes.add(t)}add(t){this.classes.add(t),this.changed=!0}remove(t){this.classes.delete(t),this.changed=!0}commit(){if(this.changed){let t="";this.classes.forEach(i=>t+=i+" "),this.element.setAttribute("class",t)}}}const ot=new WeakMap,rt=(at=t=>i=>{if(!(i instanceof M)||i instanceof I||"class"!==i.committer.name||i.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:e}=i,{element:s}=e;let n=ot.get(i);void 0===n&&(s.setAttribute("class",e.strings.join(" ")),ot.set(i,n=new Set));const o=s.classList||new nt(s);n.forEach(i=>{i in t||(o.remove(i),n.delete(i))});for(const i in t){const e=t[i];e!=n.has(i)&&(e?(o.add(i),n.add(i)):(o.remove(i),n.delete(i)))}"function"==typeof o.commit&&o.commit()},(...t)=>{const i=at(...t);return u.set(i,!0),i});var at;const lt=_`
.container {
    display: flex;
    flex-direction: row;
...
var ht=function(t,i,e,s){for(var n,o=arguments.length,r=o<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,e):s,a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(i,e,r):n(i,e))||r);return o>3&&r&&Object.defineProperty(i,e,r),r};let ct=class extends it{constructor(){super(...arguments),this._query="(max-width: 800px)",this._isMobile=window.visualViewport.width<800,this.image="data:image/png;base64,",this.containerClasses={container:!0,mobile:!1},this.headerClasses={header:!0,"header-mobile":!1},this.data={name:"-Empty name-",description:"-Empty description-",website:"-Empty website url-",repo:null,download:null}}connectedCallback(){super.connectedCallback()}_handleMediaQuery(t){this._isMobile=t.detail.value,this.containerClasses={container:!0,mobile:this._isMobile.valueOf()},this.headerClasses={header:!0,"header-mobile":this._isMobile.valueOf()}}render(){this.containerClasses={container:!0,mobile:this._isMobile.valueOf()},this.headerClasses={header:!0,"header-mobile":this._isMobile.valueOf()};var t=this.data.download?U`
    ...
    `}};ct.styles=[lt],ht([V()],ct.prototype,"_query",void 0),ht([V()],ct.prototype,"_isMobile",void 0),ht([V()],ct.prototype,"image",void 0),ht([V()],ct.prototype,"containerClasses",void 0),ht([V()],ct.prototype,"headerClasses",void 0),ht([V({attribute:"data",converter:t=>{if("string"==typeof t)return JSON.parse(t)}})],ct.prototype,"data",void 0),ct=ht([q("jwc-project-card")],ct);const At=_`
    .container {
        flex-direction: column;
        flex-wrap: wrap;
...
/**
 * @license
 * Copyright (c) 2021 Jesidea Authors. All rights reserved.
 */;var dt=function(t,i,e,s){for(var n,o=arguments.length,r=o<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,e):s,a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(i,e,r):n(i,e))||r);return o>3&&r&&Object.defineProperty(i,e,r),r};let ut=class extends it{constructor(){super(...arguments),this._query="(max-width: 800px)",this._isMobile=window.visualViewport.width<800,this.containerClasses={container:!0,mobile:!1},this.headerClasses={header:!0,"header-mobile":!1},this.data={title:"-Empty title-",image:"/assets/caracolillo-project.png",description:"-Empty description-",url:"-Empty website url-",date:null,tags:null}}connectedCallback(){super.connectedCallback()}_handleMediaQuery(t){this._isMobile=t.detail.value,this.containerClasses={container:!0,mobile:this._isMobile.valueOf()},this.headerClasses={header:!0,"header-mobile":this._isMobile.valueOf()}}_handleClick(){window.open(this.data.url)}render(){return this.containerClasses={container:!0,mobile:this._isMobile.valueOf()},this.headerClasses={header:!0,"header-mobile":this._isMobile.valueOf()},U`
        <lit-media-query
          .query="${this._query}"
          @changed="${this._handleMediaQuery}"
        >
        </lit-media-query>
        <div class=${rt(this.containerClasses)} @click="${this._handleClick}">
          <div class=${rt(this.headerClasses)}>
            <h2>${this.data.title}</h2>
            <div class="extra-data">
                <p class="date">${this.data.date}</p>
                <p class="tags">${this.data.tags}</p>
            </div>
          </div>
          <div class="img" style="background-image: url(${this.data.image})"></div>
        </div>
      `}};ut.styles=[At],dt([V()],ut.prototype,"_query",void 0),dt([V()],ut.prototype,"_isMobile",void 0),dt([V()],ut.prototype,"containerClasses",void 0),dt([V()],ut.prototype,"headerClasses",void 0),dt([V({attribute:"data",converter:t=>{if("string"==typeof t)return JSON.parse(t)}})],ut.prototype,"data",void 0),ut=dt([q("jwc-post-card")],ut);const mt=_`
  :host {
    display: block;
    font-family: var(--theme-font-family);
    width: 100%;
 ...
 * Copyright (c) 2020 Jesidea Authors. All rights reserved.
 */
var pt=function(t,i,e,s){for(var n,o=arguments.length,r=o<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,e):s,a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(i,e,r):n(i,e))||r);return o>3&&r&&Object.defineProperty(i,e,r),r};let gt=class extends it{constructor(){super(...arguments),this._query="(max-width: 800px)",this._isMobile=window.visualViewport.width<800,this._isMenuMobileVisible=!1,this.image="http://jesidea.com/home/img/supermoco-julio-2020.png",this.data={name:"Javier Escacena",username:null,occupation:"Programmer",location:"Cercedilla, Madrid, Spain",company:"@paradigmate",companyUrl:"https://twitter.com/paradigmate?lang=en",email:"javier.escacena@gmail.com",website:"http://jesidea.com",twitter:"@javiescacena",linkedin:"https://www.linkedin.com/in/jescacena/",github:"jescacena"}}_handleMediaQuery(t){this._isMobile=t.detail.value}render(){return U`
      <lit-media-query
        .query="${this._query}"
        @changed="${this._handleMediaQuery}"
      >
    ...
    `}};gt.styles=[mt],pt([V()],gt.prototype,"_query",void 0),pt([V()],gt.prototype,"_isMobile",void 0),pt([V()],gt.prototype,"_isMenuMobileVisible",void 0),pt([V()],gt.prototype,"image",void 0),pt([V({attribute:"data",converter:t=>{if("string"==typeof t)return JSON.parse(t)}})],gt.prototype,"data",void 0),gt=pt([q("jwc-user-profile")],gt);const bt=_`
...
`;var wt=function(t,i,e,s){for(var n,o=arguments.length,r=o<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,e):s,a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(i,e,r):n(i,e))||r);return o>3&&r&&Object.defineProperty(i,e,r),r};let yt=class extends it{constructor(){super(...arguments),this._query="(max-width: 800px)",this._isMobile=window.visualViewport.width<800,this._isMenuMobileVisible=!1,this.logo="data:image/png;base64,",this.menuItems=[{label:"Home",url:"/home"},{label:"About",url:"/home/about"},{label:"Articles",url:"/home/articles"}]}_handleMediaQuery(t){this._isMobile=t.detail.value}_handleClick(){this._toggleMenuMobile()}_toggleMenuMobile(){this._isMenuMobileVisible=!this._isMenuMobileVisible}renderMenuItems(){return this.menuItems.map(t=>U`<li><a href=${t.url}>${t.label}</a></li>`)}renderMenu(){return U`
      ${this._isMobile?U`<a
          ...
          /></a>`:U`<ul class="menu-desktop">
            ${this.renderMenuItems()}
          </ul>`}
    `}renderMenuMobile(){const t={"menu-mobile":!0,visible:this._isMenuMobileVisible.valueOf()};return U`
      ${this._isMobile?U` <div class=${rt(t)}>
            <div class="close" @click="${this._toggleMenuMobile}">X</div>
            <ul>
              ${this.renderMenuItems()}
            </ul>
          </div>`:U``}
    `}render(){const t=this.renderMenu();return U`
      <lit-media-query
        .query="${this._query}"
        @changed="${this._handleMediaQuery}"
      >
    ...
    `}};yt.styles=[bt],wt([V()],yt.prototype,"_query",void 0),wt([V()],yt.prototype,"_isMobile",void 0),wt([V()],yt.prototype,"_isMenuMobileVisible",void 0),wt([V()],yt.prototype,"logo",void 0),wt([V({attribute:"menu-items",converter:t=>{if("string"==typeof t)return JSON.parse(t)}})],yt.prototype,"menuItems",void 0),yt=wt([q("jwc-layout-header")],yt);const ft=_`
  :host {
    //  position: relative;
  }
...
`;var xt;!function(t){t.Github="github",t.Linkedin="linkedin",t.Twitter="twitter"}(xt||(xt={}));
/**
 * @license
 * Copyright (c) 2020 Jesidea Authors. All rights reserved.
 */
var vt=function(t,i,e,s){for(var n,o=arguments.length,r=o<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,e):s,a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(i,e,r):n(i,e))||r);return o>3&&r&&Object.defineProperty(i,e,r),r};let Rt=class extends it{constructor(){super(...arguments),this._query="(max-width: 800px)",this._isMobile=window.visualViewport.width<800,this._isMenuMobileVisible=!1,this.socialLinkItems=[{type:xt.Github,url:"https://github.com/jescacena"},{type:xt.Linkedin,url:"https://www.linkedin.com/in/jescacena"},{type:xt.Twitter,url:"https://twitter.com/javiescacena"}]}_handleMediaQuery(t){this._isMobile=t.detail.value}_getIconBySocialNetwork(t){switch(t){case xt.Github:return"data:image/png;base64,";case xt.Linkedin:return"data:image/png;base64,";case xt.Twitter:return"data:image/png;base64,";default:return console.log("Error _getIconBySocialNetwork: no icon for this network type"),""}}_renderItems(){return this.socialLinkItems.map(t=>U`<li>
        <a target="_blank" href=${t.url} class="social-link-item"
          ><img src=${this._getIconBySocialNetwork(t.type)}
        /></a>
      </li>`)}render(){const t=(new Date).getFullYear();return U`
      <lit-media-query
        .query="${this._query}"
        @changed="${this._handleMediaQuery}"
      >
    ...
    `}};Rt.styles=[ft],vt([V()],Rt.prototype,"_query",void 0),vt([V()],Rt.prototype,"_isMobile",void 0),vt([V()],Rt.prototype,"_isMenuMobileVisible",void 0),vt([V({attribute:"social-link-items",converter:t=>{if("string"==typeof t)return JSON.parse(t)}})],Rt.prototype,"socialLinkItems",void 0),Rt=vt([q("jwc-layout-footer")],Rt);
/**
 * @license
 * Copyright (c) 2020 Jesidea Authors. All rights reserved.
 */
var Mt=function(t,i,e,s){for(var n,o=arguments.length,r=o<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,e):s,a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(i,e,r):n(i,e))||r);return o>3&&r&&Object.defineProperty(i,e,r),r};let kt=class extends it{constructor(){super(...arguments),this.icon=null,this.header=null,this.source=[]}render(){return U` <div>JESidea jwc-quote-random-box</div> `}};kt.styles=_`
    :host {
      display: block;
      border: solid 1px gray;
      padding: 16px;
  ...
  `,Mt([V()],kt.prototype,"icon",void 0),Mt([V()],kt.prototype,"header",void 0),Mt([V()],kt.prototype,"source",void 0),kt=Mt([q("jwc-quote-random-box")],kt);export{Rt as JwcLayoutFooter,yt as JwcLayoutHeader,ut as JwcPostCard,ct as JwcProjectCard,kt as JwcQuoteRandomBox,gt as JwcUserProfile,st as MyElement};
